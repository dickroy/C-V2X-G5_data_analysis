...
Public Function FindConstraintViolations(ByVal numViolations2Find As Long) As Long
    ...
    If numViolations2Find = 0 Then
        ...
        wsLog.Cells(3, baseOutCol).Value = "Timestamp (local time):"
        ...
        wsLog.Cells(6, baseOutCol).Value = "Num SFs with TXs):"
        wsLog.Cells(6, baseOutCol + 1).Value = 0
        wsLog.Cells(7, baseOutCol).Value = "Num SFs with multiple TXs (Groups):"
        wsLog.Cells(7, baseOutCol + 1).Value = 0
        wsLog.Cells(8, baseOutCol).Value = "Num Groups with Constraint Violations (Catalog IDs 1-" & NumConstraints & "):"
        wsLog.Cells(8, baseOutCol + 1).Value = 0
        wsLog.Cells(9, baseOutCol).Value = "Warning Groups (Catalog IDs 1-" & NumWarnings & "):"
        wsLog.Cells(9, baseOutCol + 1).Value = 0
        wsLog.Cells(12, baseOutCol).Value = "Row"
        wsLog.Cells(12, baseOutCol + 1).Value = "SFN"
        wsLog.Cells(12, baseOutCol + 2).Value = "Type"
        wsLog.Cells(12, baseOutCol + 3).Value = "Description"
        wsLog.Range(wsLog.Cells(12, baseOutCol), wsLog.Cells(12, baseOutCol + 3)).Font.Bold = True
    End If
    ...
    Do While i <= UBound(data, 1)
        ...
        If startRow < endRow Then mFCV_GroupCount = c + 1
...
NextGroup:
    ...
    If numViolations2Find = 0 Then
        ...
        wsLog.Cells(6, baseOutCol + 1).Value = mFCV_SFNCount
        wsLog.Cells(7, baseOutCol + 1).Value = mFCV_GroupCount
        wsLog.Cells(8, baseOutCol + 1).Value = mFCV_CsetCount
        wsLog.Cells(9, baseOutCol + 1).Value = mFCV_WarningGroupCount
        wsLog.Cells(1, baseOutCol).Font.Bold = True

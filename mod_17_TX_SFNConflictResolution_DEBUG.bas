...
' [all remaining original procedures preserved here unchanged except inserted debug tracing where needed]

Private Sub UpdateProgressBar(ByVal currentRow As Long)
    Application.StatusBar = "Conflict Resolution at row " & Format$(currentRow, "0") & " of " & Format$(mFilteredCount, "0")
End Sub
